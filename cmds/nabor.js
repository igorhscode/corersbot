...
let role1 = message.guild.roles.find(role => role.name === "・⚡️ › Sun Moder")
    ...
    Наш сервер ищет коммуникабельных и ответственных ребят! Если ты готов уделять свое время, силы и делиться своей дружелюбностью с другими участниками - добро пожаловать на наш сервер!
