...
${em2} В самом начале Ивентер распределяет роли в лс участникам. Мирный житель, Полицейский, Доктор, Мафия и Дон. Или же вас могут добавить в закрытые чаты ролей.Если Вам не написали в личные сообщения роль, то Вы являетесь мирным жителем. 
