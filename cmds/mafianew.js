...
module.exports.run = async (bot,message,args) => {
    ...
    let role2 = message.guild.roles.find(role => role.name === "・🌿 › EventMod")
...
${em2} В самом начале ${role2} распределяет роли в лс участникам. Мирный житель, Полицейский, Доктор, Мафия и Дон. Или же вас могут добавить в закрытые чаты ролей.Если Вам не написали в личные сообщения роль, то Вы являетесь мирным жителем. 
